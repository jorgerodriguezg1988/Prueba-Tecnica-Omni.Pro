...
exports.commandParams = exports.requestName = exports.stringify = exports.stepMessage = exports.withTry = exports.filterCommandLog = exports.logNameFn = exports.ignoreAllCommands = exports.COMMAND_REQUEST = exports.ARGS_TRIM_AT = void 0;
const _1 = require("./");
...
const filterCommandLog = (command, ignoreCommands) => {
    ...
    return ((_b = cmdLogs.filter(log => {
        ...
        const isGroupEnd = !!(attr === null || attr === void 0 ? void 0 : attr.groupEnd);
        const isEmitOnly = attr === null || attr === void 0 ? void 0 : attr.emitOnly;
